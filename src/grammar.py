...
label = (pp.Word(pp.alphas) + pp.Suppress(':')).setParseAction(lambda r: (FPP.on_label, r))
...
macro_dw = (pp.Suppress("DW") + pp.Word(pp.alphas) + multi).setParseAction(lambda r: (FPP.issue_macro_dw, r))
macro_call = (pp.Suppress("CALL") + refname).setParseAction(lambda r: (FPP.issue_macro_call, r))
macro_func = (pp.Suppress("FUNC") + pp.Word(pp.alphas)).setParseAction(lambda r: (FPP.issue_macro_func, r))

# Macro-struct
struct_begin = (pp.Suppress("STRUCT") + pp.Word(pp.alphas)).setParseAction(lambda r: (FPP.macro_begin_struct, r))
field_type = pp.Or(pp.Literal("DW"))
struct_field = (field_type + pp.Word(pp.alphas)).setParseAction(lambda r: (FPP.macro_struct_field, r))
...
macro_ds = (pp.Suppress("DS") + refname + pp.Word(pp.alphas) + multi).setParseAction(lambda r: (FPP.issue_macro_ds, r))
...
ptr_tail = (pp.Word(pp.alphas) + pp.Suppress("#") + refname).setParseAction(lambda r: (FPP.issue_macro_ptr_tail, r))
