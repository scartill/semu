...
class MacroFPP(FPP):
    ...
    # Macros
    def issue_dw(self, tokens: List[str]):
    ...
    # CALL <func-ref>
    # Invalidates 'h'
    def issue_call(self, tokens: List[str]):
    ...
    # FUNC <func-name>
    def begin_func(self, tokens: List[str]):
        name = tokens[0]
    ...
    def func_var(self, tokens: List[str | int]):
        func = cast(Func, self.context)
