...
from semu.pseudopython.elements import Element, PhysicalExpression
...
@dataclass
class Compare(PhysicalExpression):
    ...
    def __init__(
        ...
        left: PhysicalExpression, op: CompareOp, right: PhysicalExpression
    ):
